...
jQuery(document).ready(function () {jQuery('.icp-auto').iconpicker();});
jQuery('#dvsocialicons_repeat').find('.cmb-add-group-row').on('click', function () {
    jQuery.iconpicker.batch('.icp-auto', 'destroy');
    setTimeout(function(){ jQuery('.icp-auto').iconpicker(); }, 500);
});